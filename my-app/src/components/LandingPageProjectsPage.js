...
export default function LandingPageProjectsPage() {
  return (
    <div
      className="border-t-[1px]  border-[#c4c4f5] mx-8 px-8 mb-6 py-4 lg:px-12"
      id="Projects"
    >
      ...
      <div className="projects-container-cards flex-col  flex-row-edited p-4 my-4 lg:space-x-[10vw]">
        <motion.div
          ...
          className="projects-container-card px-2 py-2 bg-[#9b59b6] mt-8 text-[#ffd700] border-2 rounded-xl flex-col "
        >
