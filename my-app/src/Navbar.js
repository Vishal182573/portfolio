...
export default function Navbar() {
  ...
  return (
    <div className=" p-3 h-[4rem]  sticky top-0 bg-[#1a1a1a] flex lg:justify-around justify-between items-center border-b-[0.5px] border-white rounded  ">
      ...
      <div className={`right-part hidden lg:block`}>
        ...
        <li className="cursor-pointer hover:text-[#aaaaf4] hover:text-[1.05rem]"><a href="/">Home</a></li>
          <li className="cursor-pointer hover:text-[#aaaaf4] hover:text-[1.05rem]"><a href="/">About</a></li>
          <li className="cursor-pointer hover:text-[#aaaaf4] hover:text-[1.05rem]"><a href="/">Services</a></li>
          <li className="cursor-pointer hover:text-[#aaaaf4] hover:text-[1.05rem]"><a href="/">Projects</a></li>
          <li className="cursor-pointer hover:text-[#aaaaf4] hover:text-[1.05rem]"><a href="/">Contact Me</a></li>
        </ul>
      </div>
